...
//                 <button disabled={videoSource === 'both'} onClick={() => switchMode('both')} style={{ flex: 1, padding: 5 }}>Camera + Screen</button>
//               </>
//             )}
//           </div>

//           {/* VÙNG CHỨA TỔNG BAO GỒM SCREEN VÀ CAMERA CHO BROADCASTER */}
//           <div style={{
//             position: 'relative',
//             width: '100%',
...
//             gap: videoSource === 'both' ? 10 : 0 // Tự động tạo khoảng cách khi có 2 luồng
//           }}>
            
//             {/* 1. KHUNG CHÍNH (SCREEN HOẶC CAMERA ĐƠN) */}
//             <div style={{
//               position: 'relative',
//               width: '100%',
//               aspectRatio: isPortrait ? '9/16' : '4/3',
//               maxHeight: videoSource === 'both' ? 'none' : '85vh', 
//               background: '#000',
//               borderRadius: 8,
//               overflow: 'hidden'
//             }}>
